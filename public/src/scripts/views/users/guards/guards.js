...
//
import { deleteEntity, getEntityData, registerEntity, setPassword, setUserRole, updateEntity, getUserInfo, sendMail, getFilterEntityData, getFilterEntityCount, postNotificationPush, setFile } from "../../../endpoints.js";
import { drawTagsIntoTables, inputObserver, inputSelect, CloseDialog, filterDataByHeaderType, getVerifyEmail, getVerifyUsername, pageNumbers, fillBtnPagination, searchUniversalValue, generateFileSimpleXls, generateFileSimpleCsv, sleep, formatearFechaPorZona } from "../../../tools.js";
                ...
                exportButton.addEventListener('click', async () => {
                    if(!onPressed){
                        ...
                        if(totalRegisters === undefined){
                            ...
                            generateFileSimpleXls(users,"Guardias","xls");
                            const _dialog = document.getElementById('dialog-content');
                            new CloseDialog().x(_dialog);
                            onPressed = false;
                        }
            ...
            _fileExportGuard.addEventListener('click', async () => {
                if(!onPressed){
                    ...
                    if(totalRegisters === undefined){
                        ...
                        generateFileSimpleCsv(users,"Guardias","csv");
                        const _dialog = document.getElementById('dialog-content');
                        new CloseDialog().x(_dialog);
                        onPressed = false;
                    }
            ...
            _fileExportCustomer.addEventListener('click', async () => {
                if(!onPressed){
                    ...
                    if(totalRegisters === undefined){
                        ...
                        generateFileSimpleXls(customers,"Empresas_activas","xls");
                        const _dialog = document.getElementById('dialog-content');
                        new CloseDialog().x(_dialog);
                        onPressed = false;
                    }
