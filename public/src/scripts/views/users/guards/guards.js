...
//
import { deleteEntity, getEntityData, registerEntity, setPassword, setUserRole, updateEntity, getUserInfo, sendMail, getFilterEntityData, getFilterEntityCount, postNotificationPush, setFile, createGuardPhoto, getGuardPhotos, getFile } from "../../../endpoints.js";
    ...
    edit(container, data) {
        ...
        const RInterface = async (entities, entityID) => {
            ...
            const renderPhotoGrid = async (page) => {
                ...
                nextBtn.disabled = photos.length < PHOTOS_PAGE_SIZE;
            };
            ...
            updateButton.addEventListener('click', async() => {
                ...
                if (_photoInput.files.length > 0) {
                    ...
                    if (photoResult?.fileRef) {
                        ...
                        try {
                            await createGuardPhoto(entityId, photoFileRef);
                        } catch (err) {
                            console.error('createGuardPhoto failed:', err);
                        }
                    }
                }
